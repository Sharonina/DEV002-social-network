...
const FormularioRegistroMascota = () => {
    ...
    const view = `
        ...
        <div class='fotoPerfil'>
            <figure>
                <img id='profileImg' src='./assets/dog-iconuser.png' alt='imagen de usuario'/>
            </figure>
            <label for='file' class='addImageButton'>+</label>
            <input type='file' id='file' class='hide' accept='image' />
        </div>
        <form>
            <div>
